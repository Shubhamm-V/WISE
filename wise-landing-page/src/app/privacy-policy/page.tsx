...
const page = (props: Props) => {
  return (
    <div className="privacyContainer">
      ...
      <p>
        This privacy policy applies to the WISE - Empowering women health app
        (hereby referred to as "Application") for mobile devices that was
        created by MIT Sambhajinagar (hereby referred to as "Service Provider")
      ...
      <p>
        ...
        identifiable information, including but not limited to Email, full name,
        age, phone, city, state. The information that the Service Provider
      ...
      <p>
        ...
        Application, please contact them at sunilkuyare@gmail.com and they will
      ...
      <div>
        ...
        <p>
          ...
          Service Provider does not knowingly collect personallyidentifiable
          information from children under 13 years of age. In the casethe
          Service Provider discover that a child under 13 has providedpersonal
          information, the Service Provider will immediatelydelete this from
          their servers. If you are a parent or guardianand you are aware that
          your child has provided us withpersonal information, please contact
          the Service Provider (sunilkuyare@gmail.com) so thatthey will be able
      ...
      <br />
      <p>This privacy policy is effective as of 2024-08-28</p>
      <br />
      ...
      <p>
        ...
        Provider via email at sunilkuyare@gmail.com.
      </p>
    </div>
  );
};
